...
<footer class="footer">
  <center>
    Sistem Informasi Penjualan Roti SIP © 2017 TIM SIP
  </center>
</footer>
<!-- ============================================================== -->
<!-- End footer -->
...
<script type="text/javascript" src="assets/js/custom/stok.js"></script>
<script type="text/javascript" src="assets/js/custom/config.js"></script>
</body>
